...
public class DeepAnalysisService {
	...
	private static final String SAMPLE_INPUT_XMI = "{\n" + 
			...
			"  },\n" + 
			"  \"data\": {\n" + 
			"    \"text\": \"Sí, me gustia suscribirme a First Reception Service.\"" + 
			"  } \n" + 
			"}";
	...
	private static final String SAMPLE_INPUT_TURN2 = "{\n" + 
			...
			"  },\n" + 
			"  \"data\": {\n" + 
			"    \"text\": \"Terrassa, es una ciudad de la región cel centro-este de Cataluña, en la provincia de Barcelona, comarca del Vallès Occidental, de la que es cocapital junto con Sabadell.\"" + 
			"  } \n" + 
			"}";
	/**
	...
	public DeepAnalysisService() throws WelcomeException {
		...
		client = new MindspacesBackendClient<>("https://taln.upf.edu/mindspaces/mindspaces-services-es/", "es", XmiOutputImpl.class);
		//client = new MindspacesBackendClient<>("http://localhost:8080/mindspaces-services-es/", "es", XmiOutputImpl.class);
	}    
	...
	public IAnalysisOutput analyze(
		...
		try {
			...
			log.info("calling mindspaces-services-es backend");
